// lib/screens/course_management_settings_screen.dart
import 'package:flutter/material.dart';

class CourseManagementSettingsScreen extends StatelessWidget {
  ...
  CourseManagementSettingsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Course Management Settings")),
      body: ListView(
